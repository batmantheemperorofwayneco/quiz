        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link to="/student/forgot-password" className="text-sm text-green-600 hover:text-green-800">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="text-center mt-6">
            <p className="text-gray-600">
              ...
              <Link to="/student/register" className="text-green-600 hover:text-green-800 font-medium">
                Sign up here
              </Link>
            </p>
          </div>
